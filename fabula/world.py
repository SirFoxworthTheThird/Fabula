...
CLIENT_TEMPLATES: dict[str, str] = {
    ...
    "nothing_to_take_back": "There is not that much to take back.",
    "steering": "— the director has been told: {note} —",
    "no_steering": "The director has not been told anything. /steer <what you want>.",
    "steering_off": "— the director has been told nothing in particular —",
    "back_how_many": "How many of your lines? /back, or /back 3.",
    "taken_back": "— taken back {lines} line(s). The scene stands where it did. —",
